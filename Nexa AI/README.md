...
> ⚠️ **API Endpoint:** After deployment, API Gateway may generate a new endpoint. Update the `API_URL` in `frontend/index.html` with the new `/chat` endpoint, then redeploy the frontend if required.
